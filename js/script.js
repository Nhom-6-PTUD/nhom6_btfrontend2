$(function () {
    ...
    var current_score = 0; // Initialize the score
    ...
    function playGame() {
        ...
        game_interval = setInterval(function () {
            if (collision(bird, pole_1) || // Nếu chú chim va chạm với ống trên
                ...
                parseInt(bird.css('top')) <= 0 || // Hoặc chú chim va chạm với khung game trên
            ...
            else
            {
                ...
                if (pole_current_position > container_width - bird_left)
                {
                    ...
                    {
                        current_score = parseInt(score.text()) + 1;
                        score.text(current_score); // Cập nhật điểm
                        score_updated = true;
    ...
    $(document).keydown(function (e) {
        go_up = setInterval(up, 40); // Bắt đầu bay lên khi nhấn mũi tên lên
    });
    ...
    function stop_the_game() {
        clearInterval(game_interval); // Xoá realtime chơi game
        game_over = true;
